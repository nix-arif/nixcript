        ...
        <div className="border border-border rounded-xl overflow-hidden mb-5">
          <div className="flex items-center justify-between px-4 py-3 bg-muted/30 border-b border-border">
            <div>
              ...
              <div className="text-xs text-muted-foreground mt-0.5">Fill in your product codes, then upload the file below to generate the certificate PDF.</div>
            </div>
          ...
          <div className="px-4 py-2.5 border-t border-border bg-muted/10 flex flex-wrap gap-3 text-[11px] text-muted-foreground">
            ...
            <span>One code per row. Only products with an MDA certificate PDF on file will be included in the output.</span>
          </div>
        </div>
      )}
